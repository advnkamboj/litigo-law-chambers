      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-32 pb-24 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="font-display leading-none mb-6 reveal opacity-0 translate-y-[30px]">
            <span className="block text-6xl sm:text-7xl lg:text-9xl font-light text-foreground">
              {data.titleLines[0]}
            </span>
            <span className="block text-6xl sm:text-7xl lg:text-9xl font-light italic text-gold">
              {data.titleLines[1]}
            </span>
            <span className="block text-6xl sm:text-7xl lg:text-9xl font-light text-foreground">
              {data.titleLines[2]}
        ...
        <div className="mt-20 pt-12 border-t border-border grid grid-cols-2 lg:grid-cols-4 gap-8 reveal opacity-0 translate-y-[30px]">
          {data.stats.map((stat, i) => (
            <div key={i}>
              <div className="font-heading text-6xl font-light text-gold leading-none">
                {stat.number}
              </div>
