      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-0.5">
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[0].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[0].desc}</p>
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[1].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[1].desc}</p>
            <div className="mt-6 w-8 h-px transition-all duration-300 group-hover:w-16 bg-gold"></div>
          </div>
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[2].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[2].desc}</p>
            <div className="mt-6 w-8 h-px transition-all duration-300 group-hover:w-16 bg-gold"></div>
          </div>
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[3].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[3].desc}</p>
            <div className="mt-6 w-8 h-px transition-all duration-300 group-hover:w-16 bg-gold"></div>
          </div>
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[4].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[4].desc}</p>
            <div className="mt-6 w-8 h-px transition-all duration-300 group-hover:w-16 bg-gold"></div>
          </div>
          ...
          <div className="service-card relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl before:absolute before:inset-0 before:border before:border-transparent before:bg-[linear-gradient(135deg,var(--color-gold-dim),transparent)] before:bg-origin-border before:[mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] before:mask-exclude before:opacity-0 hover:before:opacity-100 bg-card p-8 group cursor-default reveal opacity-0 translate-y-[30px]">
            ...
            <h3 className="font-display text-2xl font-light text-foreground mb-3 group-hover:text-gold-400 transition-colors">{data.items[5].title}</h3>
            <p className="text-sm text-muted-foreground leading-relaxed font-light">{data.items[5].desc}</p>
            <div className="mt-6 w-8 h-px transition-all duration-300 group-hover:w-16 bg-gold"></div>
          </div>
        </div>
      </div>
